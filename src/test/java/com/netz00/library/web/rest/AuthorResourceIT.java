package com.netz00.library.web.rest;
...
import com.netz00.library.IntegrationTest;
import com.netz00.library.domain.Author;
import com.netz00.library.domain.Genre;
import com.netz00.library.repository.AuthorRepository;
import com.netz00.library.service.AuthorService;
import com.netz00.library.service.dto.AuthorDTO;
import com.netz00.library.service.mapper.AuthorMapper;
...
class AuthorResourceIT {
    ...
    private static final Integer DEFAULT_BIRTRTHYEAR = 1;
    private static final Integer UPDATED_BIRTRTHYEAR = 2;
    ...
    public static Author createEntity(EntityManager em) {
        Author author = new Author()
            ...
            .birtrthyear(DEFAULT_BIRTRTHYEAR)
    ...
    public static Author createUpdatedEntity(EntityManager em) {
        Author author = new Author()
            ...
            .birtrthyear(UPDATED_BIRTRTHYEAR)
    ...
    void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getFullname()).isEqualTo(DEFAULT_FULLNAME);
        assertThat(testAuthor.getBirtrthyear()).isEqualTo(DEFAULT_BIRTRTHYEAR);
        assertThat(testAuthor.getDeathyear()).isEqualTo(DEFAULT_DEATHYEAR);
        assertThat(testAuthor.getNote()).isEqualTo(DEFAULT_NOTE);
    }
    ...
    void getAllAuthors() throws Exception {
        ...
        restAuthorMockMvc
            ...
            .andExpect(jsonPath("$.[*].birtrthyear").value(hasItem(DEFAULT_BIRTRTHYEAR)))
    ...
    void getAuthor() throws Exception {
        ...
        restAuthorMockMvc
            ...
            .andExpect(jsonPath("$.birtrthyear").value(DEFAULT_BIRTRTHYEAR))
    ...
    void putNewAuthor() throws Exception {
        ...
        updatedAuthor.fullname(UPDATED_FULLNAME).birtrthyear(UPDATED_BIRTRTHYEAR).deathyear(UPDATED_DEATHYEAR).note(UPDATED_NOTE);
        ...
        Author testAuthor = authorList.get(authorList.size() - 1);
        assertThat(testAuthor.getFullname()).isEqualTo(UPDATED_FULLNAME);
        assertThat(testAuthor.getBirtrthyear()).isEqualTo(UPDATED_BIRTRTHYEAR);
        assertThat(testAuthor.getDeathyear()).isEqualTo(UPDATED_DEATHYEAR);
        assertThat(testAuthor.getNote()).isEqualTo(UPDATED_NOTE);
    }
    ...
    void partialUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.birtrthyear(UPDATED_BIRTRTHYEAR);
    ...
    void fullUpdateAuthorWithPatch() throws Exception {
        ...
        partialUpdatedAuthor.fullname(UPDATED_FULLNAME).birtrthyear(UPDATED_BIRTRTHYEAR).deathyear(UPDATED_DEATHYEAR).note(UPDATED_NOTE);
