...
import com.netz00.library.repository.BookRepository;
import com.netz00.library.service.BookService;
import com.netz00.library.service.dto.BookDTO;
import com.netz00.library.service.mapper.BookMapper;
...
class BookResourceIT {
    ...
    private static final String DEFAULT_ISBN = "247305338X";
    private static final String UPDATED_ISBN = "9795397059219";
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().isbn(DEFAULT_ISBN).title(DEFAULT_TITLE).year(DEFAULT_YEAR).note(DEFAULT_NOTE);
        // Add required entity
        Genre genre;
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().isbn(UPDATED_ISBN).title(UPDATED_TITLE).year(UPDATED_YEAR).note(UPDATED_NOTE);
        // Add required entity
        Genre genre;
        if (TestUtil.findAll(em, Genre.class).isEmpty()) {
    ...
    void putNewBook() throws Exception {
        ...
        updatedBook.isbn(UPDATED_ISBN).title(UPDATED_TITLE).year(UPDATED_YEAR).note(UPDATED_NOTE);
    ...
    void partialUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.isbn(UPDATED_ISBN);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.isbn(UPDATED_ISBN).title(UPDATED_TITLE).year(UPDATED_YEAR).note(UPDATED_NOTE);
