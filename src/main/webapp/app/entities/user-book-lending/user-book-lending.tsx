  ...
  return (
    <div>
      <h2 id="user-book-lending-heading" data-cy="UserBookLendingHeading">
        <Translate contentKey="libraryApp.userBookLending.home.title">User Book Lendings</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="libraryApp.userBookLending.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="libraryApp.userBookLending.home.createLabel">Create new User Book Lending</Translate>
          </Link>
        </div>
      </h2>
        ...
        {userBookLendingList && userBookLendingList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="libraryApp.userBookLending.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('loantime')}>
                  <Translate contentKey="libraryApp.userBookLending.loantime">Loantime</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('returntime')}>
                  <Translate contentKey="libraryApp.userBookLending.returntime">Returntime</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="libraryApp.userBookLending.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('note')}>
                  <Translate contentKey="libraryApp.userBookLending.note">Note</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="libraryApp.userBookLending.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="libraryApp.userBookLending.book">Book</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {userBookLendingList.map((userBookLending, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`libraryApp.LendingStatus.${userBookLending.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="libraryApp.userBookLending.home.notFound">No User Book Lendings found</Translate>
            </div>
          )
        )}
      </div>
