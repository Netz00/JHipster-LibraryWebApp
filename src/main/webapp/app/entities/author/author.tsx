            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('fullname')}>
                  <Translate contentKey="libraryApp.author.fullname">Fullname</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('birtrthyear')}>
                  <Translate contentKey="libraryApp.author.birtrthyear">Birtrthyear</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('deathyear')}>
                  <Translate contentKey="libraryApp.author.deathyear">Deathyear</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('note')}>
                  <Translate contentKey="libraryApp.author.note">Note</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
